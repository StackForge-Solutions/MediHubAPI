    ...
    @Query(value = """
            ...
            """, countQuery = """
                ...
                WHERE a.appointmentDate BETWEEN :start AND :end
                  ...
                  AND (:patientId IS NULL OR a.patient.id = :patientId)
            """)
    Page<VisitRowDTO> findVisitRows(@Param("start") LocalDate start, @Param("end") LocalDate end, @Param("doctorId") Long doctorId, @Param("patientId") Long patientId, Pageable pageable);
